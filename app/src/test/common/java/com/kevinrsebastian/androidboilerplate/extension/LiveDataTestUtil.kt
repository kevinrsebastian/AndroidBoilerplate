package com.kevinrsebastian.androidboilerplate.extension
...
/**
 * Checks if the [LiveData] value has not been set yet by using [LiveData.getOrAwaitValue].
 */
fun <T> LiveData<T>.hasNotBeenSet(): Boolean {
    return try {
